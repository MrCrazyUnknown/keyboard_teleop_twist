...
------------------------------------------------------------------------------------------------------------\n"""
    ...
    def move(self):
        ...
        self.msg.linear.y = (flags[KeyCode(char = 'a')] - flags[KeyCode(char = 'd')]) * self.speed
        self.msg.linear.z = (flags[Key.space] - flags[Key.shift]) * self.speed
        self.msg.angular.z = (flags[KeyCode(char = 'q')] - flags[KeyCode(char = 'e')]) * self.rot
